        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  method="get" onsubmit="yaCounter41590214.reachGoal('price'); return true;">
    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  method="get" onsubmit="yaCounter41590214.reachGoal('consultation'); return true;">
    ...
    <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  method="get" onsubmit="yaCounter41590214.reachGoal('comerc'); return true;">
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  method="get" onsubmit="yaCounter41590214.reachGoal('zvon'); return true;">
                    <div class="form-group">
                        <label for="">Как к Вам обращаться?*</label>
                        <input class="form-control" name="name" required>
                    </div>
...
<div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  method="get" onsubmit="yaCounter41590214.reachGoal('zayavka'); return true;">
                    <div class="form-group">
                        <label for="">Как к Вам обращаться?*</label>
                        <input class="form-control" name="name" required>
                    </div>
